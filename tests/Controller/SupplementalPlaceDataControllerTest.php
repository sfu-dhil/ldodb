...
class SupplementalPlaceDataControllerTest extends ControllerBaseCase
{
    ...
    public function testAdminEdit() : void {
        ...
        $this->assertSame(200, $this->client->getResponse()->getStatusCode());
        $this->assertSame(1, $responseCrawler->filter('td:contains("120")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("Catfish Creek")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("12.4")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("13.4")')->count());
    }
