...
class ReferencedPersonController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $dql = 'SELECT e FROM AppBundle:ReferencedPerson e ORDER BY e.id';
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm(AppBundle\Form\ReferencedPersonType::class, $referencedPerson);
    ...
    public function editAction(Request $request, ReferencedPerson $referencedPerson)
    {
        ...
        $editForm = $this->createForm(AppBundle\Form\ReferencedPersonType::class, $referencedPerson);
