...
class ReferencedPersonController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\ReferencedPersonType', $referencedPerson);
    ...
    {
        $editForm = $this->createForm('AppBundle\Form\ReferencedPersonType', $referencedPerson);
