...
class SupplementalPlaceDataController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $dql = 'SELECT e FROM AppBundle:SupplementalPlaceData e ORDER BY e.id';
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm(AppBundle\Form\SupplementalPlaceDataType::class, $supplementalPlaceDatum);
    ...
    public function editAction(Request $request, SupplementalPlaceData $supplementalPlaceDatum)
    {
        ...
        $editForm = $this->createForm(AppBundle\Form\SupplementalPlaceDataType::class, $supplementalPlaceDatum);
