...
class DigitalCopyHolderControllerTest extends WebTestCase
{
    ...
    public function testAdminEdit() {
        ...
        $form = $formCrawler->selectButton('Update')->form([
            // DO STUFF HERE.
            // 'digital_copy_holders[FIELDNAME]' => 'FIELDVALUE',
        ]);
    ...
    public function testAdminDelete() {
        ...
        $preCount = count($em->getRepository(DigitalCopyHolder::class)->findAll());
        $client = $this->makeClient([
            'username' => 'admin@example.com',
            'password' => 'supersecret',
        ]);
        ...
        $em->clear();
        $postCount = count($em->getRepository(DigitalCopyHolder::class)->findAll());
